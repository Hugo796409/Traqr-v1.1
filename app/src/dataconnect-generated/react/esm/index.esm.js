import { listUsersRef, createSkillRef, updateSwapRequestRef, deleteReviewRef, connectorConfig } from '../../esm/index.esm.js';
...
export function useUpdateSwapRequest(dcOrOptions, options) {
  const { dc: dcInstance, vars: inputOpts } = validateArgs(connectorConfig, dcOrOptions, options);
  function refFactory(vars) {
